...
/* harmony export */   morph: function() { return /* binding */ src_default; }
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _fireline_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./fireline/index.js */ "./src/js/fireline/index.js");
...
alpinejs__WEBPACK_IMPORTED_MODULE_1__["default"].plugin(_fireline_index_js__WEBPACK_IMPORTED_MODULE_0__["default"]);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   diffAndPatch: function() { return /* binding */ diffAndPatch; },
/* harmony export */   injectScripts: function() { return /* binding */ injectScripts; },
/* harmony export */   replaceHtml: function() { return /* binding */ replaceHtml; }
/* harmony export */ });
/**
 ...
 */
function replaceHtml(targetEl, html) {
...
function diffAndPatch(parent, oldNode, newNode) {
  ...
  if (oldNode.nodeType === Node.ELEMENT_NODE) {
    ...
    oldAttributes.forEach(attr => {
      ...
      if (!newNode.hasAttribute(attr.name) && !isManagedByAlpine && !(attr.name === 'style' && oldAttributes.some(attr => attr.name === 'x-show')) // Preserve `style` for x-show
      ) {
...
/* harmony export */ });
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./helpers */ "./src/js/fireline/helpers.js");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   replaceRouterHtml: function() { return /* binding */ replaceRouterHtml; },
/* harmony export */   safeReplaceHtml: function() { return /* binding */ safeReplaceHtml; },
/* harmony export */   safeReplaceStyles: function() { return /* binding */ safeReplaceStyles; },
/* harmony export */   triggerError: function() { return /* binding */ triggerError; }
/* harmony export */ });
/* harmony import */ var _dom__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./dom */ "./src/js/fireline/dom.js");
 ...
 */
function triggerError(error, context = false) {
  if (context) {
...
function safeReplaceStyles(head) {
  try {
    ...
    styles.forEach(newStyle => {
      const existingStyle = document.head.querySelector(newStyle.tagName === 'LINK' ? `link[rel="stylesheet"][href="${newStyle.href}"]` : 'style');
      if (existingStyle) {
 ...
 */
function replaceRouterHtml(html) {
  // Get the router target element and throw an error if it's not found
  //    console.log(window.FireLine.settings.targetEl)
  ...
  (0,_dom__WEBPACK_IMPORTED_MODULE_0__.replaceHtml)(targetEl, html);
  //Alpine.morph(targetEl, html);
}

/***/ }),

/***/ "./src/js/fireline/index.js":
/*!**********************************!*\
  !*** ./src/js/fireline/index.js ***!
  \**********************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./page */ "./src/js/fireline/page.js");
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./helpers */ "./src/js/fireline/helpers.js");
...
/* harmony default export */ __webpack_exports__["default"] = (Alpine => {
  ...
  const FireLine = Alpine.reactive({
    ...
    events: {
      ...
      // Event triggered at the start of loading
    ...
    settings: {
       ...
       * @type {string}
       */
      targetEl: '.blockblog-fireline-root #blockblog-content',
      /**
    ...
    context: {
       ...
       */
      navigate: url => (0,_page__WEBPACK_IMPORTED_MODULE_0__.navigateTo)(url),
      /**
       * Reloads the current path.
       */
      reload: () => (0,_page__WEBPACK_IMPORTED_MODULE_0__.navigateTo)(window.location.href),
      /**
       * Replace the router content.
       * @param {string} html - The HTML content to update the element with.
       * @returns {void}
       */
      replaceHtml: html => (0,_helpers__WEBPACK_IMPORTED_MODULE_1__.safeReplaceHtml)(html),
      /**
       * Server side form submission.
       * @param {HTMLFormElement} formEl - The form element to be submitted. 
       * @returns {void}
       */
      formSubmit: formEl => (0,_page__WEBPACK_IMPORTED_MODULE_0__.formSubmission)(formEl)
    }
  });
  ...
  Alpine.directive('navigate', (el, {
    ...
    const onClick = event => {
      ...
      (0,_page__WEBPACK_IMPORTED_MODULE_0__.navigateTo)(url);
    };
  ...
  Alpine.directive('submit', (el, {
    ...
    const onSubmit = event => {
      ...
      // Submit the form
      (0,_page__WEBPACK_IMPORTED_MODULE_0__.formSubmission)(el);
    };
  ...
  window.addEventListener('popstate', () => (0,_page__WEBPACK_IMPORTED_MODULE_0__.navigateTo)(window.location.href, false));
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   formSubmission: function() { return /* binding */ formSubmission; },
/* harmony export */   navigateTo: function() { return /* binding */ navigateTo; }
/* harmony export */ });
/* harmony import */ var _fetch__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./fetch */ "./src/js/fireline/fetch.js");
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./helpers */ "./src/js/fireline/helpers.js");
...
function navigateTo(url, pushState = true) {
  ...
  (0,_fetch__WEBPACK_IMPORTED_MODULE_0__.ajaxRequest)(url).then(response => {
    ...
    (0,_helpers__WEBPACK_IMPORTED_MODULE_1__.safeReplaceHtml)(html);
    (0,_helpers__WEBPACK_IMPORTED_MODULE_1__.safeReplaceStyles)(head);

    // When the content is updated, wait for the next tick
    Alpine.nextTick(() => {
      // Update the browser's history state and fire the 'current' route
      if (pushState && window.FireLine.redirectedUrl === undefined) window.history.pushState({}, '', url);
      ...
      // Fire the 'onNavigation' event
      if (window.FireLine.redirectedUrl === undefined) document.dispatchEvent(window.FireLine.events.navigate);
...
function formSubmission(formEl) {
  (0,_fetch__WEBPACK_IMPORTED_MODULE_0__.ajaxRequest)(formEl.getAttribute('action'), formEl.getAttribute('method'), new FormData(formEl)).then(response => {
    // If the response is invalid then do nothing
    if (!response) return;

    // If the response contains a "status" property set to "success", reset the form
    if (response.status && response.status === 'success') formEl.reset();
    ...
    // If the response contains a "content" property, update the document with the specified content
      ...
      (0,_helpers__WEBPACK_IMPORTED_MODULE_1__.safeReplaceHtml)(response.html);
    }
...
/* harmony import */ var _fireline_init_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./fireline-init.js */ "./src/js/fireline-init.js");
